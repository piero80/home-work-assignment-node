          ...
          if (cartItems.length > 0) {
            ...
            cartItems.forEach((cartItem) => {
              ...
              menuItems.forEach((menuItem) => {
                if (cartItem.menuItemId == menuItem.id) {
                  ...
                  totalAmount += menuItem.price_cents * cartItem.quantity;
                }
              });
            });
            ...
            helpers.stripeCharge(totalAmount, (err) => {
              if (!err) {
                ...
                callback(500, {
                  Error: "Unable to charge credit card in Stripe: " + err,
                });
              }
            });
          } else {
